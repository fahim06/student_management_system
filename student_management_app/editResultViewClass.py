...
from student_management_app.models import Student, Subject, StudentResult
...
class EditResultViewClass(View):
    def get(self, request, *args, **kwargs):
        ...
        return render(request, "staff_template/edit_student_result_template.html", {"form": edit_result_form})
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            form = EditResultForm(request.POST, staff_id=request.user.id)
            return render(request, "staff_template/edit_student_result_template.html", {"form": form})
