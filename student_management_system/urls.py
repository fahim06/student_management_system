...
urlpatterns = [
                  ...
                  path('student_disapprove_leave/<int:leave_id>', hodViews.student_disapprove_leave,
                       name="student_disapprove_leave"),
                  path('staff_approve_leave/<int:leave_id>', hodViews.staff_approve_leave,
                       name="staff_approve_leave"),
                  path('staff_disapprove_leave/<int:leave_id>', hodViews.staff_disapprove_leave,
